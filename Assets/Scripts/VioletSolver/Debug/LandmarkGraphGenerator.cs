...
namespace VioletSolver.Debug
{
    internal static class LandmarkGraphGenerator
    {
        ...
        internal static Graph GeneratePoseGraph()
        {
            ...
            Node[] betweenEars  = { new((int)poseIndex.LeftEar),        new((int)poseIndex.LeftEyeOuter),   new((int)poseIndex.LeftEye),        new((int)poseIndex.LeftEyeInner), new((int)poseIndex.Nose), new((int)poseIndex.RightEyeInner), new((int)poseIndex.RightEye), new((int)poseIndex.RightEyeOuter), new((int)poseIndex.RightEar) };
        ...
        internal static Graph GenerateHandGraph()
        {
            ...
            Node[] thumb = { new((int)handIndex.ThumbTip), new((int)handIndex.ThumbIp), new((int)handIndex.ThumbMcp), new((int)handIndex.ThumbCmc), new((int)handIndex.Wrist) };
            Node[] index = { new((int)handIndex.IndexFingerTip), new((int)handIndex.IndexFingerDip), new((int)handIndex.IndexFingerPip), new((int)handIndex.IndexFingerMcp), new((int)handIndex.Wrist) };
            Node[] middle = { new((int)handIndex.MiddleFingerTip), new((int)handIndex.MiddleFingerDip), new((int)handIndex.MiddleFingerPip), new((int)handIndex.MiddleFingerMcp), new((int)handIndex.Wrist) };
            Node[] ring = { new((int)handIndex.RingFingerTip), new((int)handIndex.RingFingerDip), new((int)handIndex.RingFingerPip), new((int)handIndex.RingFingerMcp), new((int)handIndex.Wrist) };
            Node[] pinky = { new((int)handIndex.PinkyTip), new((int)handIndex.PinkyDip), new((int)handIndex.PinkyPip), new((int)handIndex.PinkyMcp), new((int)handIndex.Wrist) };
